...
public class EmailCampaignsAsap extends BaseTest{
	
	@Test
	public void NavigateToEMailCampaigns() throws InterruptedException
	{
		...
		Campname.click();
		Campname.sendKeys("AutoCampaign");
	...
	WebElement test=driver.findElement(By.xpath("(.//*[@id='email-template-list'])[2]/li[1]/div/figure"));
	 action.moveToElement(test);
       ...
       wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//span[contains(text(),'SAVE')]/parent::button")));
		...
		/*
		 * WebElement sendTest=
		 * driver.findElement(By.xpath(".//*[@placeholder='Enter an email to test']"));
		 * wait.until(ExpectedConditions.visibilityOf(sendTest)); sendTest.click();
		 * sendTest.sendKeys("bhargavi@gleantap.com");
		 * System.out.println("Sent the test email"); driver.findElement(By.
		 * xpath(".//*[@placeholder='Enter an email to test']/following-sibling::button"
