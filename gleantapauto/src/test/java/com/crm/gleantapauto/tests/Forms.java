...
public class Forms extends BaseTest{
	...
	@Test
	public void NewsLetterOptInAddform() throws InterruptedException, IOException, AWTException

	{
		NavigateToForm();
		driver.findElement(By.xpath(".//span[contains(text(),'Newsletter Opt-in')]")).click();
		...
		{
			driver.findElement(By.xpath(".//input[@name='form-name']")).sendKeys(Formname1);
			...
			driver.findElement(By.xpath(".//a[@title='Remove Element']")).click();
			FormControls();
	...
	public void FormControls() throws InterruptedException, AWTException
	{
       ...
       if(Automatedform.equalsIgnoreCase(Formname1))
       {
